...
export default function AddBlockButton({ onSelect, placeholder, mode }: Props) {
  ...
  return (
    <>
      ...
      <BlocksMenu anchorEl={menuAnchorEl} setAnchorEl={setMenuAnchorEl} onSelect={onSelect} mode={mode} />
    </>
  );
}
